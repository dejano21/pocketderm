  ...
  return (
    <div className="screen" style={{ paddingTop: 12 }}>
      ...
      <div className="grid-cards" style={{ marginBottom: 16 }}>
        ...
        {/* Segmentation note */}
        <div className="card" style={{ display: "flex", gap: 10, alignItems: "flex-start", background: "var(--primary-light)", border: "1px solid #a5f3fc" }}>
      ...
      {/* Explanation + Recommendations side by side on desktop */}
      <div className="grid-cards" style={{ marginBottom: 16 }}>
        <div className="card">
